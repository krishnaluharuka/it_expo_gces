...
<body>
  ...
  <footer class="contact">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-lg-4 col-md-12 col-sm-12 p-5 ">
        ...
        <div class="Contact-info col-lg-4 col-md-12 col-sm-12 p-5">
          <h3>Contact-Info</h3>
          <p>
        ...
        <!-- <div class="quick-links col-lg-4 col-md-12 col-sm-12 pt-5">
          <h3>Quick-Links</h3> -->
         ...
         -->
         <div class="quick-links col-lg-4 col-md-12 col-sm-12  p-5">
          <h3>Quick-Links</h3>
          <p><a href="home.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>Home</a></p>
          <p><a href="aboutus.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>About Us</a></p>
          <p><a href="reviews.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>Reviews</a></p>
          <p><a href="contact.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>Contact Us</a></p>
          <p><a href="faq_display.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>FAQ</a></p>
          <p><a href="recommendation.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>Recommendation</a></p>
          <p><a href="wishlist.php" class="text-decoration-none"><i class="bi bi-arrow-right pe-2"></i>Wishlist</a></p>
        </div>
      </div>
    </div>
    </div>
