...
if (!isset($_SESSION['user_id'])) {
  ...
  if (isset($_GET['product_id'])) {
    ...
    if ($result_count == 1) {
      echo "<script>alert('Product already exist in wishlist! if you like to remove it from wishlist visit wishlist Page')</script>";
            ...
            while ($row = mysqli_fetch_array($result1)) {
              ...
              while ($row_product = mysqli_fetch_array($result_products)) {
                ...
                echo "<div class='col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-3'>
                  ...
                  <div class='card-body'>
                  <h4 class='card-title'><a href='wishlist.php?delete_wish=$product_id' class='btn1 ms-0 bi bi-heart-fill text-danger fs-5 me-2' title='Like this image'></a>$product_title</h4>
