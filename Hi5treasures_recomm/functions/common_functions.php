  ...
  if (isset($_GET['category'])) {
    ...
    while ($row = mysqli_fetch_assoc($result_query)) {
      ...
      echo "<div class='col-md-4 col-sm-6 mb-3'>
          ...
          <div class='card-body'>
          <h4 class='card-title'><a href='wishlist.php?product_id=$product_id' class='btn1 ms-0 bi bi-heart-fill fs-5 me-2' title='Like this image'></a>$product_title</h4>
  ...
  if (isset($_GET['product_id'])) {
    ...
    while ($row = mysqli_fetch_assoc($result_query)) {
      ...
      echo "<section class='products' id='productss'>
                  ...
                  <div class='cards-wrapper'>
                    <div class='card border shadow py-3 mb-3' style='width: 18rem;'>
                      <div class='image-wrapper'>
